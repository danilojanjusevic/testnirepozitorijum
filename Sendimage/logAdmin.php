...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        $sql = "SELECT idAdmin, username, password FROM admin WHERE username = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    mysqli_stmt_bind_result($stmt, $idAdmin, $username, $hashed_password);
				...
				<!-- Menu -->
					<nav id="menu">
						...
						<ul>
							...
							<li><a href="admin.php">Send photo</a></li>
